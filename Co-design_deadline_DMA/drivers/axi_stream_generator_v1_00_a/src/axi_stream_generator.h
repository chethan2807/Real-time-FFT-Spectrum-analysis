/*****************************************************************************
* Filename:          D:\STUDIES\NTU_PROJECTS\EMBEDDED_SYSTEM_DESIGN\FFT_HARDWARE_PROJ\Backup\FFT_DMA\drivers/axi_stream_generator_v1_00_a/src/axi_stream_generator.h
* Version:           1.00.a
* Description:       axi_stream_generator () Driver Header File
* Date:              Sun Nov 08 02:44:06 2015 (by Create and Import Peripheral Wizard)
*****************************************************************************/

#ifndef AXI_STREAM_GENERATOR_H
#define AXI_STREAM_GENERATOR_H
...
*    example code (axi_stream_generator_selftest.c) for details.
*/

#define  axi_stream_generator(\
		 input_slot_id,\
		 output_slot_id,\
		 input_0,      \
		 output_0       \
